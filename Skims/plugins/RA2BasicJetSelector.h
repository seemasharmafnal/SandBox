...
#ifndef SandBox_Skims_RA2BasicJetSelector_h
#define SandBox_Skims_RA2BasicJetSelector_h
...
namespace pat {
  ...
  class RA2BasicJetSelector : public edm::EDFilter {
  public:


  RA2BasicJetSelector( edm::ParameterSet const & params ) : 
    edm::EDFilter( ),
